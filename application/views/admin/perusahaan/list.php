							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td width="250">
											<a href="<?php echo site_url('admin/perusahaan/edit/'.$perusahaan->merek_id) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('admin/perusahaan/delete/'.$perusahaan->merek_id) ?>')"
