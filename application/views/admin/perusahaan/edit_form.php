			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/perusahaan/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
						...
						<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							...
							<input type="hidden" name="id" value="<?php echo $merek->merek_id?>" />

                            <div class="form-group">
								<label for="produk_merek">Nama Perusahaan*</label>
								<input class="form-control <?php echo form_error('produk_merek') ? 'is-invalid':'' ?>"
								 type="text" name="produk_merek" placeholder="Nama perusahaan..." value="<?php echo $merek->produk_merek ?>" />
							...
							<div class="form-group">
								...
								<input type="hidden" name="foto_bawaan" value="<?php echo $merek->merek_logo ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('merek_lokasi') ? 'is-invalid':'' ?>"
								 type="text" name="merek_lokasi" placeholder="Kota Perusahaan..." value="<?php echo $merek->merek_lokasi ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('merek_deskripsi') ? 'is-invalid':'' ?>"
								 name="merek_deskripsi" placeholder="Deskripsi perusahaan..."><?php echo $merek->merek_deskripsi ?></textarea>
								<div class="invalid-feedback">
